...
- **The ecosystem:** CWL is an ecosystem built around **naruon** — the
  ...
  must ALSO work as a git submodule, grown separately and together. The
  canonical component map and product ownership live in
  ...
  read it there rather than duplicating the list here, so renames land in
  one place.
