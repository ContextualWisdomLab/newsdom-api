...
## 2026-08-05 - Add OpenAPI Schema Examples for DX
**Learning:** In backend-only applications without a frontend, providing explicit examples in OpenAPI/Swagger schemas serves as the primary UX (Developer Experience).
**Action:** Enhance Pydantic schemas with `json_schema_extra={"example": ...}` for better API documentation.
