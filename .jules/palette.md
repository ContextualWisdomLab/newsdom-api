...
## 2026-08-27 - Swagger UI Authentication Persistence
**Learning:** In FastAPI, developers lose their Bearer tokens when refreshing the Swagger UI page, leading to a frustrating DX.
**Action:** Added `persistAuthorization: True` to `swagger_ui_parameters` to preserve credentials across refreshes.
