...
## 2024-08-17 - Swagger UI Auth Persistence

**Learning:** Swagger UI에서 페이지 새로고침 시 인증 토큰이 유지되도록 설정하면 개발자 경험(DX)이 크게 향상됩니다.
**Action:** FastAPI `swagger_ui_parameters`에 `"persistAuthorization": True`를 추가하여 인증 토큰을 보존하도록 개선했습니다.
