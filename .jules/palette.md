...
## 2026-08-29 - Preserve Authorization in Swagger UI
...
**Action:** Configure `swagger_ui_parameters` with `"persistAuthorization": True` to avoid having developers re-authenticate after refreshing the API documentation page.
