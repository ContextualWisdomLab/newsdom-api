...
## 2026-09-01 - Swagger UI DX Improvement
**Learning:** Adding `"persistAuthorization": True` to FastAPI's `swagger_ui_parameters` significantly improves developer experience by preserving API tokens across page reloads.
**Action:** Always include this parameter when configuring Swagger UI for authenticated APIs.
