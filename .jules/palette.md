...
## 2026-08-12 - Swagger UI Developer Experience (DX) Improvement

**Learning:** Adding explicit `json_schema_extra={"example": ...}` to Pydantic schemas in FastAPI projects is a powerful way to improve DX (Developer Experience) on auto-generated OpenAPI documentation, serving as the equivalent of a UX improvement for backend APIs.
**Action:** Always ensure Pydantic fields have clear, representative examples, especially for non-obvious lists and optional fields.
