...
## 2026-08-28 - Swagger UI Authorization Persistence
**Learning:** In FastAPI, Swagger UI clears bearer tokens on refresh, requiring developers to re-authenticate constantly, creating poor DX.
**Action:** Added `persistAuthorization: True` to `swagger_ui_parameters` to preserve credentials across page reloads.
