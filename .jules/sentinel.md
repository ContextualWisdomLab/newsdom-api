...
## 2025-03-03 - [HIGH] Fix DoS via TypeError in hmac.compare_digest
**Vulnerability:** Unhandled TypeError exceptions when processing untrusted client input containing non-ASCII characters passed to Python's hmac.compare_digest() result in 500 errors and potential DoS.
**Learning:** hmac.compare_digest() does not support comparing strings containing non-ASCII characters.
