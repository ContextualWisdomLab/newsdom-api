...
## 2026-08-08 - Ignore pypdf vulnerabilities in .trivyignore
**Vulnerability:** pypdf vulnerabilities CVE-2026-71852 and CVE-2026-71870.
**Learning:** Upgrading the dependency directly can cause upstream regressions or break fuzz CI. The fuzz CI contract mandates specific formatting for `.trivyignore`.
**Prevention:** Only suppress unfixable vulnerabilities in `.trivyignore` with explicit revisit condition comments.
