...
## 2026-09-26 - Fix dependency vulnerabilities in uv.lock
**Vulnerability:** Trivy detected critical and high CVEs (CVE-2026-63374, CVE-2026-64847, CVE-2026-84381, CVE-2026-84382, CVE-2026-84379, CVE-2026-84380, CVE-2026-84309, CVE-2026-84310, CVE-2026-84311) in dependencies like `anyio`, `httpx2`, `httpcore2`, and `pypdf`.
**Learning:** Hardcoded dependency requirements and tests can prevent lockfile updates to secure versions. Tests `test_project_metadata.py` and `test_pypdf_security_floor.py` strictly asserted `pypdf>=6.15.0,<7.0` and caused test failures when `uv add pypdf>=6.19.0` updated the floor to fix CVE-2026-84309/84310/84311.
**Action:** When updating vulnerable dependencies, identify and update any strict version floor tests or strings (like `_REQUIRED_PYPDF_VERSION = (6, 19, 0)`) in test files (`tests/test_pypdf_security_floor.py`) and documentation (`CHANGELOG.md`) to reflect the new patched baseline.
