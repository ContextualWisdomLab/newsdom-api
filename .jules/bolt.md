...
## 2026-09-04 - Strix CI transient errors
**Learning:** The Strix CI security scan can fail randomly with environment execution errors like `ModuleNotFoundError` completely unrelated to code modifications.
**Action:** Re-trigger the CI with an empty/amended commit when Strix fails due to scanner execution defects rather than security findings.
