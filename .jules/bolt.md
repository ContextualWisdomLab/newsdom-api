...
## 2026-08-21 - Avoid small chunk sizes in async file uploads
...
**Action:** Use larger chunk sizes (e.g. 1MB) defined as a named constant for reading uploaded files asynchronously to improve performance.
