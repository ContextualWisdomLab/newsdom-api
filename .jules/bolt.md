...
## 2024-07-24 - Avoid small chunk sizes for FastAPI async file uploads
...
**Action:** Default to larger chunk sizes (e.g., 1MB / `1024 * 1024`) to significantly improve performance when reading uploaded files.
