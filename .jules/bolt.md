...
**Action:** Improve performance by using larger chunk sizes (e.g., 1MB) defined as a named constant (`UPLOAD_READ_CHUNK_SIZE_BYTES`) and ensure tests use this constant instead of hardcoded equivalent values.
