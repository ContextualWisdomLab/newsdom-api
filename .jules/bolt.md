...
## 2024-08-01 - Avoid small chunk sizes in async file uploads
...
**Action:** Default to larger chunk sizes (e.g., 1MB / `1024 * 1024`) when reading uploaded files asynchronously to significantly improve performance.
