...
## 2026-08-20 - Optimize Upload Chunk Size for Async File Reads
...
**Action:** Use larger chunk sizes (e.g., 1MB) defined as a named constant (e.g., `UPLOAD_READ_CHUNK_SIZE_BYTES = 1024 * 1024`) to significantly improve parsing upload performance. Update related tests to use this constant instead of hardcoded equivalent values to prevent test failures.
