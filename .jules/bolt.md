...
## 2024-07-21 - Avoid small chunk sizes for asynchronous file uploads
**Learning:** For asynchronous file uploads in FastAPI/Starlette, avoid small chunk sizes (e.g., 8192 bytes) with `await file.read()`, as it creates massive threadpool and context-switching overhead.
