...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" '"context": 200000' "opencode config uses the GitHub Models GPT-5 200k context window"
	assert_file_contains "$workflow_file" '"output": 100000' "opencode config uses the GitHub Models GPT-5 100k output window"
