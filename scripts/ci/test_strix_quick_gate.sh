...
assert_strix_workflow_pr_trigger_hardened() {
	...
	assert_file_contains "$workflow_file" "github.event.inputs.strix_llm || 'github-models/openai/gpt-5'" "strix workflow defaults PR Strix scans to GitHub Models GPT-5"
...
FAIL: strix workflow defaults PR Strix scans to GitHub Models GPT-5 (missing 'github.event.inputs.strix_llm || 'github-models/openai/gpt-5'')
