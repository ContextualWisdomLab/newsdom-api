...
def test_validate_pdf_structure_rejects_unexpected_exceptions(monkeypatch, tmp_path):
    def reject_pdf_with_type_error(_stream, *, strict):
        raise TypeError("unexpected type error during validation")

    monkeypatch.setattr("newsdom_api.main.PdfReader", reject_pdf_with_type_error)
