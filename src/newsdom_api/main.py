...
async def parse(
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(delete=False) as temporary_file:
            ...
            # Performance Optimization: Using a larger chunk size (1MB instead of 8192 bytes)
            # significantly reduces asynchronous threadpool and context-switching overhead during file read.
