...
@app.post("/parse", response_model=ParseResponse, summary="Parse PDF", tags=["Parser"])
async def parse(file: Annotated[UploadFile, File(description="The scanned newspaper PDF file to parse")]) -> ParseResponse:
