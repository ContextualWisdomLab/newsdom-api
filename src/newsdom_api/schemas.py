...
class BoundingBox(BaseModel):
    ...
    y1: float = Field(
        ...
        json_schema_extra={"example": 400.8},
    )
...
class CaptionNode(BaseModel):
    ...
    text: str = Field(
        ...
        json_schema_extra={"example": "Figure 1: Example chart"},
    )
...
class ImageNode(BaseModel):
    ...
    path: str = Field(
        ...
        json_schema_extra={"example": "images/page1_img1.png"},
    )
...
class ArticleNode(BaseModel):
    ...
    article_id: str = Field(
        ...
        json_schema_extra={"example": "article_001"},
    )
    headline: str = Field(
        ...,
        description="Primary headline text for the article.",
        json_schema_extra={"example": "Local Sports Team Wins Championship"},
    )
    bbox: Optional[BoundingBox] = Field(
        default=None,
...
class ParseResponse(BaseModel):
    ...
    document_id: str = Field(
        ...
        json_schema_extra={"example": "doc_12345abc"},
    )
