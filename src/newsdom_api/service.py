...
# ⚡ Bolt: Pre-compile translation table for hot path string normalization
_NORMALIZATION_TABLE = str.maketrans("\\", "/", "\0")
...
def _safe_upload_filename(filename: str) -> str:
    ...
    normalized = filename.translate(_NORMALIZATION_TABLE)
