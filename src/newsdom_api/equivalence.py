...
def _derived_metrics(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    # ⚡ Bolt: Cache repeated dictionary lookups in local variables to avoid redundant .get() overhead,
    # and use exact type matching (type() is list) instead of isinstance() to reduce function-call overhead
    # in this structural parsing path.
