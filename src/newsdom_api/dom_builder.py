...
def _html_safe_text(value: Any) -> str:
    ...
    # ⚡ Bolt: Unconditionally call html.escape as its C implementation is highly optimized
    # and avoiding a regex pre-check avoids Python-level pattern matching overhead.
