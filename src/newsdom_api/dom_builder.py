...
def build_dom(
    ...
    # ⚡ Bolt: Consolidated three separate passes (two any() with generator expressions
    # and the grouping loop) into a single O(N) loop to reduce overhead and multiple type checks.
