...
- `pypdf>=6.19.0,<7.0` for PDF parsing;
...
Pillow 12.3.0, pypdf 6.19.0, mkdocs-material 9.7.7, and
...
6.14.2 artifact. The same repository had already produced a hash-locked 6.19.0
...
therefore move together to 6.19.0 rather than hiding the findings in
`.trivyignore`.
...
review remain mandatory. PyPI's official JSON metadata confirms the 6.19.0
...
Python Packaging Authority. (2026c). *pypdf 6.19.0*. Python Package Index.
    Retrieved August 9, 2026, from https://pypi.org/project/pypdf/6.19.0/
