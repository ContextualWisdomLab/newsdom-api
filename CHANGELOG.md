...
### Added
- [CLI] 파싱된 NewsDOM JSON 데이터에서 불필요한 요소(이미지, 광고, 헤더/푸터 등)를 제거하거나 특정 페이지만 남기는 `tools/filter_dom.py` 도구를 추가했습니다.
...
### Security
- Trivy CI 검사(trivy-fs)에서 보고된 취약점(CVE-2026-84381, CVE-2026-84382, CVE-2026-84379, CVE-2026-84380, CVE-2026-84309, CVE-2026-84310, CVE-2026-84311)을 해결하기 위해 `httpcore2`, `httpx2`, `pypdf` 패키지를 업데이트했습니다.
