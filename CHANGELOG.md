...
### Changed
- `PageNode.page_number`, optional page geometry와 반복 텍스트 블록 필드, 그리고 `ImageNode.media_type`은 실제 필드 타입에 맞는 plural JSON Schema examples를 발행하여 OpenAPI 소비자가 응답 형태를 즉시 확인할 수 있습니다.
