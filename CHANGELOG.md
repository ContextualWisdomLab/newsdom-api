...
### Changed
- Consolidated automated-agent journals under lowercase `.jules/`,
  removed duplicate issue entries, and documented open-PR coordination
  rules for Sentinel, Bolt, and Palette.
