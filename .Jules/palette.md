...
## 2026-06-27 - Pydantic Field Descriptions for API Schema DX
**Learning:** Enhancing Pydantic schemas with Field descriptions significantly improves OpenAPI/Swagger UI readability, providing vital UX (Developer Experience) for headless APIs.
**Action:** Always add descriptive Field parameters to fundamental API schemas.
